                    ...
                    if (!empty($items)) {
                        ...
                        if (!empty($items)) {
                            ...
                            foreach ($items as $key3 => $item) {
                                if($type == 'projects') $report .= "<li>".$this->format->date($item['project_date'])." - ".$item['project_name']."</li>";
                                if($type == 'support') $report .= "<li>".$this->format->date($item['support_date'])." - ".$item['support_name']."</li>";
                            }
