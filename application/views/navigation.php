...
<div class="navbar-collapse collapse">
    <ul class="nav navbar-nav">
		...
		?>
		<li class="dropdown">
            <a href="#" class="dropdown-toggle" aria-expanded="false" role="button" data-toggle="dropdown">New <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
                <li><?php echo anchor('projects/form', 'New Project'); ?></li>
                <li><?php echo anchor('support/form', 'New Support'); ?></li>
            </ul>
        </li>
		...
		<li class="<?php echo $active['reports']; ?>"><?php echo anchor('reports','Reports'); ?></li>
    </ul>
