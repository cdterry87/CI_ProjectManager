...
--
-- Host: localhost
-- Generation Time: Jan 17, 2019 at 04:48 PM
...
--
ALTER TABLE `customers_systems`
  MODIFY `customer_system_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `departments_projects`
  MODIFY `department_project_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `employees_projects`
  MODIFY `employee_project_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `projects_history`
  MODIFY `project_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `projects_notes`
--
ALTER TABLE `projects_notes`
  MODIFY `project_note_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `projects_reminders`
--
ALTER TABLE `projects_reminders`
  MODIFY `project_reminder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `projects_reminders_employees`
--
ALTER TABLE `projects_reminders_employees`
  MODIFY `project_reminder_employee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `projects_tasks_employees`
  MODIFY `project_task_employee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `support_history`
  MODIFY `support_history_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `systems`
  MODIFY `system_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
